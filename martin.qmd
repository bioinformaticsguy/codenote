...
- Short
    - Pipeline working for almost all the workflows except the following.
        ...
        - Thinking of skipping annotations as wel can standardize for short and long read to have same annotations for each?
            - SNV annotations are most important, So that is needed to be done and also it is needed to adapt to the pipeline.
    ...
    - Retriving reads for Short read samples. 
        ...
        - *** Combining all the files and doing demultiplexing again. We need to do this when we use different tools there will be differene in sample stratistics. Link avalible (https://github.com/fulcrumgenomics/fqtk) 
